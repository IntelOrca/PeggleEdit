...
{
    /// <summary>
    /// Wrapper around the j2k-codec shipped with Peggle.
    /// This seems to be the only way to load some of Peggle's .jp2 backgrounds successfully.
    /// Even the latest version of j2k-codec can not open them.
    /// </summary>
    internal static class J2KCodec
    {
        ...
        [DllImport("j2k-codec", EntryPoint = "_J2K_OpenMemory@8")]
        public static extern IntPtr OpenMemory(byte[] buffer, int size);
        ...
        [DllImport("j2k-codec", EntryPoint = "_J2K_GetMetaData@20")]
        public static extern J2KError GetMetaData(IntPtr image, out int no, out J2KMetadata type, out IntPtr data, out int size);
        ...
        public static extern J2KError GetResolutions(IntPtr image, out int resolutions);
